...
public class LocationController {
    ...
    @GetMapping("/get")
    public ResponseEntity<String> getLocation(@Parameter(name="location", description="name to search", example="Isla Vista") @RequestParam String location) throws JsonProcessingException {
